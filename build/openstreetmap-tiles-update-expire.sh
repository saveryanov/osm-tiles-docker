...
if [ $# -eq 1 ] ; then
    ...
    sed "s!baseUrl=http://planet.openstreetmap.org/replication/day!baseUrl=https://planet.openstreetmap.org/replication/day!" $WORKOSM_DIR/configuration_orig.txt > $WORKOSM_DIR/configuration.txt
else
